  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col lg:flex-row items-center justify-center gap-8 w-full">
        ...
        {/* Imagen Izquierda */}
        <div className="w-full lg:w-1/4 group relative rounded-xl overflow-hidden border border-white/10 hover:border-cyan-500/50 transition-all duration-500 aspect-video lg:aspect-auto lg:h-[320px] bg-black/40 flex items-center justify-center shadow-lg hover:shadow-cyan-500/20">
           <img src="/project-1.png" alt="Dashboard del Proyecto" className="w-full h-full object-cover opacity-60 group-hover:opacity-100 group-hover:scale-105 transition-all duration-700 mix-blend-luminosity group-hover:mix-blend-normal" />
           <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex items-end p-6">
             <div className="translate-y-4 group-hover:translate-y-0 transition-transform duration-500">
               <p className="text-cyan-300 font-bold tracking-wider mb-1">DASHBOARD</p>
               <p className="text-gray-300 text-sm">Monitorización analítica en tiempo real.</p>
             </div>
           </div>
        </div>
        ...
        <div className="w-full lg:w-1/4 group relative rounded-xl overflow-hidden border border-white/10 hover:border-emerald-500/50 transition-all duration-500 aspect-video lg:aspect-auto lg:h-[320px] bg-black/40 flex items-center justify-center shadow-lg hover:shadow-emerald-500/20">
           ...
           <img src="/project-2.png" alt="Arquitectura del Código" className="w-full h-full object-cover group-hover:scale-110 group-hover:rotate-1 transition-all duration-700" />
