  ...
  slides: [
    ...
    },
    {
      ...
      data: {
        ...
        problemFlow: [
          'Suscriptor compra línea',
          'OSAC asigna número reciclado',
          'El número telefónico es vinculado a WhatsApp/Telegram',
          'El usuario no logra registrar su cuenta en redes sociales como whatsapp/telegram',
